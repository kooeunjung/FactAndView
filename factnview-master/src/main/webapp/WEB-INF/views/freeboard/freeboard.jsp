...
.visual .banner{
	...
	width: 100%;
	height: 100%;;
	background-image: url("${root }/resource/images/season.jpg");
...
<div class="col-xs-12 col-md-8 container contain">
			...
			<div class="free-list">
				...
				<c:forEach var="v" items="${pageList}">
					<ul class="collection">
						...
						<li class="list-item flex"><a href="free-detail?c=${v.id}"
							class="url">
								<div class="index">
									<p>${v.id }</p>
								</div>
								...
								<div class="title">
									<span>${v.title} <c:if test="${writedate>=today }">
											<img src="${root }/resource/images/new.jpg" />
										</c:if></span>
								</div>
	...
	<a class="waves-effect waves-light btn sitego" href="#">
		<div class="write">
			...
			<fmt:parseNumber var="pageInt" integerOnly="true"
				value="${paging/10 }" />
...
<!-- --------------------------------------검색----------------------------------------- -->
		<form class="searchbar1" action="${root }/siteboard/siteboard"
			method="GET">
			<div class="broker-expanding-search" data-expanding-search>
				<div
					class="broker-expanding-search__column broker-expanding-search__column--left">
					<input type="hidden" name="p" value="1" /> <input name="q"
						type="text"
						class="broker-expanding-search__input broker-expanding-search__input--text"
						value="${param.q}" placeholder="Siteboard Search"
						data-expanding-search-text>
				</div>
				<div
					class="broker-expanding-search__column broker-expanding-search__column--right">
					<input type="submit"
