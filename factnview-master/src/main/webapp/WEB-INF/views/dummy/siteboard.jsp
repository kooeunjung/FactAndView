				...
				<div class="flex">
					<div class="main-div">
						<ul id="breadcrumb" class="headdd">
							...
							<li><a href="?p=1"><span class="icon icon-double-angle-right"> </span>Fact</a></li>
						</ul>
						...
						<div class="free-list">
							<c:forEach var="v" items="${pageList}">
								<ul class="collection">
									...
									<div style="display: none;">
										<fmt:formatDate value="${v.regDate}" pattern="yyyy-MM-dd HH:mm:ss" var="writedate" />
									</div>
									<!--//////////// 아무거나 누르면 넘어갈꺼야! ///////////////-->
									<li class="list-item flex">
									<a href="site-reg?c=${v.id}" class="url">
											<div>
											<div class="title"> <!-- 오늘 쓴 글에 new 아이콘 달기 -->
		...
		<div class="main-div">
			...
			<div class="site-list">
				...
				<c:forEach var="n" items="${sitelist}">
					<ul class="collection">
						<div style="display: none;">
							<fmt:formatDate value="${n.regDate}" pattern="yyyy-MM-dd HH:mm:ss" var="writedate" />
						</div>
						<div style="display: none">
							<fmt:formatDate value="${now}" pattern="yyyy-MM-dd" var="today" />
						</div>
