...
<header id="header">
	<nav class="container">
	    <div class="nav-wrapper">
	      <a href="../main/index" class="brand-logo logo font"><img src="../resource/images/fnvlogo.jpg"/><div class="mlogo">Fact & View</div></a>
	     <%--  <a href="${root }/main/index" class="brand-logo logo font"><img src="${root }/resource/images/w3c.png"/><div class="mlogo">what is your needs?</div></a> --%>
	      ...
	      <ul class="right hide-on-med-and-down">
			...
			<security:authorize access="isAnonymous()">
				...
				<a class="login font pin dropdown-button"  href='#' data-activates='dropdown1'> 
				<security:authentication property="name" />
				 ...
				 <!-- Dropdown Structure -->
				  <ul id='dropdown1' class='dropdown-content'>
				    ...
				    <li><a href="../user/mypage?memberId=${loginID}"><i class="material-icons">pages</i>MyPage</a></li>
					 <security:authorize access="hasRole('ROLE_ADMIN')">
					 <li><a href="../admin/admin"><i class="material-icons">pages</i>AdminPage</a></li>
					 </security:authorize>   
				        <li class="divider"></li>
				    <li><a href="../j_spring_security_logout"><i class="material-icons">exit_to_app</i>Logout</a></li>
				  </ul>
	...
	<div id="modal110" class="modal">
		<form id="profileForm" action="${root }/joinus/profileUpdate"method="post" enctype="multipart/form-data" >
			<div class="info_top">
				...
				<!-- 추가 10.23 -->
				<div class="nickname">
					<textarea placeholder="사용할 닉네임을 만들어주세요." class="pr" name="user[nickname]" id="user_nickname"></textarea>
				</div>
				<!-- 추가 10.23 -->
				<div class="btn_area">
