...
<footer class="page-footer">
				...
				<div class="col category  column s12 m3 hide-on-small-only">
					...
					<ul>
						<c:forEach var="small" items="${bcb.smallCategory}">
							<li><a class="grey-text text-lighten-3"
								href="${root }/siteboard/siteboard?p=1&q=&bigCa=${bcb.id}&smallCa=${small.id}">
									<input type="hidden" value="${small.id }" name="SmallCa" />${small.name }</a></li>
						</c:forEach>
					</ul>
				</div>
			</c:forEach>
	...
	<div class="footer-copyright">
   	<div class="container">
         Copyright © 2017 <a class="grey-text text-lighten-4"
            href="http://blog.naver.com/kooyomi0114"
            target="_blank">kooeunjung</a> All rights reserved. <span
            class="right"><a class="grey-text text-lighten-4"
            href="http://blog.naver.com/kooyomi0114"></a></span>
            </div>
      </div>
</footer>