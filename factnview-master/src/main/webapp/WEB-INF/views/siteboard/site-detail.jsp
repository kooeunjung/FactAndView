...
<div class="container">
	<div class="section">
		...
		<!--////////////////////////////////왼쪽에 Fact Board/////////////////////////////// -->		
				...
				<a class="waves-effect waves-light btn" href="../freeboard/free-detail?c=${f.id}">fact page로 가기</a>
			...
			<%-- 	<div class="col l7 s12">
					<div class="card-panel alcaramel" style="min-height: 640px;">
						...
						<div>
							<span class="detail-title"><i class="tiny material-icons">query_builder</i>Write Time</span> 
							<span><fmt:formatDate value="${s.regDate }"	pattern="yyyy-MM-dd" /></span>
							<hr />
							<br />
						</div>
						...
						<div>
							<span class="detail-title"><i class="tiny material-icons">textsns</i>
								Comment </span>
							<c:set var="newLine" value="\r"/>
							<span>${s.content }</span>
							<hr />
						...
						<div class="flex between">
							<div>
								<a class="waves-effect waves-light btn" id="back" href="siteboard?p=${page }">목록</a>
							</div>
							<div class="right">
